...
from fate_flow.apps.test_app import manager as test_app_manager
from fate_flow.apps.zhl_app import manager as zhl_app_manager
...
if __name__ == '__main__':
    ...
    app = DispatcherMiddleware(
        manager,
        {
            ...
            '/{}/test'.format(API_VERSION): test_app_manager,
            '/{}/zhl'.format(API_VERSION): zhl_app_manager,
        }
    )
    # init
